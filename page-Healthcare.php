...
<div class="container my-5">
    <!-- Section Title -->
    <h1 class="text-center mb-5">Articles for Healthcare</h1>
        ...
        ?>
            ...
            <div class="col-md-4"> <!-- Responsive 3-column grid -->
                <div class="card h-100 shadow-sm border-0"> <!-- Card with shadow and no border -->
                    <!-- Article Image -->
                    <img src="<?php echo get_field('article_thumbnail', $healthId); ?>" 
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text text-muted">
                            <?php echo wp_trim_words(get_field('article_desc', $healthId), 20, '...'); ?>
                        </p>
                        <!-- Read More Button -->
                        <a href="<?php the_permalink($healthId); ?>" class="btn btn-sm btn-primary mt-auto align-self-start">
                            Read More
                        </a>
                    </div>
                </div>
